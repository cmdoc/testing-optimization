...
jQuery(document).ready(function () {
    ...
    jQuery("span.roomTypeDesc > div.urgentMsgCss").each(function () {
        jQuery(this).find("img").attr("class", "urgentMsgImg taoUrgencyClockBlue");
        jQuery(this).find("span").eq(0).attr("class", "taoUrgencyMsg taoBlue");
        jQuery(this).find("span").eq(1).addClass("taoUrgencyTextBlue");
    });
