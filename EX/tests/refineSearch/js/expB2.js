...
jQuery("<div id='taoNewFilters'><p><b>Refine Your Search</b></p></div>").insertAfter(jQuery("#modifySearch").next());

// Insert a DIV for the Distance from Destination block
jQuery("#taoNewFilters").append("<div id='taoDistance' class='taoBlock'></div>");
...
// Move the "Apply" button to the new DIV
var $taoApplyButton = jQuery("#btnApplyFilter");
jQuery("#taoNewFilters").append("<div id='taoBlueButton' class='taoBlock'></div>");
