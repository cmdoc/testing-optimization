jQuery("document").ready(function(){
    ...
    var taoRatePack = {};
    /******      RATE      NEW TITLE      ******/
    taoRatePack["IDME1"] = "IDME1 Title";
    taoRatePack["IGCOR"] = "IGCOR Title";
    taoRatePack["IKPCM"] = "Best Flexible Rate + 1,000 Points";
    taoRatePack["IKME3"] = "YOUR RATE IHG&reg; Rewards Club + 1,000 Points";
...
function taoChangeRateTitle(newTitle, $rateRow) {
    // This takes a new title and puts it in the right spot in the rateRow
    // DOM node.
    var $titleTag = $rateRow.find("div.rateInfoArea span.rateCategory");
    if ($titleTag.length == 0) {
        $titleTag = $rateRow.find("div.rateInfoArea span.rateHeader");
    }
