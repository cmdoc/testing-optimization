    ...
    jQuery(".rateTypeLineItems").each(function(i) {
        ...
        $taoThisRoom.find(".regularRates, .secondaryRates").each(function() {
            ...
            if ($taoThisRateRow.find("div.spotlightPointsAndCash").length > 0) {
                ...
                // Add this rate and row to taoJustPrices and taoJustRateRows.
                // We will take these arrays later and build out the SOG when
                // we are done with all of the rates for this row.
                taoJustPrices["IKME3"] = parseFloat(jQuery(this).find("div.priceInfoArea span.cc_number").text());
                ...
                jQuery(this).find(".upSellContainer").each(function() {
                    ...
                    $taoThisUpsellContainer.find("input[value='Book This Room']").each(function() {
                        ...
                        // See if this is the IKPCM or IKME1 rate. If so, Put
                        // it at the end of the 3RP div. Otherwise, add it to
                        ...
                        // processed.
                        if (taoCurrentShortRateCode == "IKPCM" || taoCurrentShortRateCode == "IKME1") {
                ...
                // Third, see if this is the IKME1 rate. If so, Put it at the
                // end of the 3RP div. Otherwise, add it to
                // taoJustPrices and taoJustRateRows. We take these
                // arrays later and build out the SOG when we are done
                // with all of the rates for this row has been
                // processed.
                if (taoShortRateCode == "IKPCM" || taoShortRateCode == "IKME1") {
