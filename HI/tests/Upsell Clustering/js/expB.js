...
!function(A) {
    ...
    mboxFactoryDefault.addOnLoad(function(){
        ...
        jQuery("input[value='Book This Room']").on('click', function () {
            if (jQuery(this).closest(".upSellContainer").siblings(".upsellHeader").length == 1) {
                mboxFactoryDefault.getSignaler().signal("mboxClickTrack", "mboxClickTrack", "clicked=BFbutton");
            }
        });
